...
| --- | --- | --- | --- |
| Docker stacks and redacted agent inventory | `host_vars/<host>/docker.yml`, `group_vars/docker_hosts/` | `playbooks/docker/docker-stacks.yml`, `playbooks/docker/docker-auto-update.yml`, `playbooks/docker/agent-docker-report.yml` | `templates/docker/`, `scripts/docker/` |
