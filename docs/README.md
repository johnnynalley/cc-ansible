...
| `docs/openclaw-heartbeats.md` | OpenClaw/Astra heartbeat scheduling, resource gates, and external checks | Heartbeat cadence, concurrency, commands, target hosts, sentinel files, or OpenClaw monitoring responsibilities change. | `playbooks/agents/openclaw.yml`, `playbooks/media/media-stack-health.yml`, `templates/openclaw/` |
| `docs/openclaw-runtime-security.md` | OpenClaw modernization, OS identities, and trust boundaries | Legacy disposition, Gateway/receiver identities, npm/plugin provenance, data migration rehearsals, canary/cutover flow, prompt-injection containment, or credential reach changes. | `playbooks/agents/openclaw-health-receiver.yml`, `playbooks/agents/openclaw-isolated-gateway.yml`, `playbooks/agents/openclaw-state-rehearsal.yml`, `playbooks/agents/openclaw-doctor-rehearsal.yml`, `scripts/agents/`, `templates/openclaw/`, `docs/openclaw-docker-access.md` |
