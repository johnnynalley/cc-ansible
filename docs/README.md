...
| `docs/openclaw-runtime-security.md` | OpenClaw OS identities and trust boundaries | Gateway/receiver identities, raw-versus-aggregate data access, canary/cutover flow, prompt-injection containment, or credential reach changes. | `playbooks/agents/openclaw-health-receiver.yml`, `scripts/agents/`, `docs/openclaw-docker-access.md` |
