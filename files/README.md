...
| --- | --- | --- | --- |
| `hermes/` | Hermes replacement, migration, profile, and behavior policy | Future isolated Hermes VM/profile deployment | Credential-free structured shadow/migration/behavior contracts plus root-owned Astra, Dubble, and Rigel identity and operating baselines. They keep delivery, scheduling, listeners, host authority, source mutation, secret copying, and cleanup disabled until later gates pass. |
