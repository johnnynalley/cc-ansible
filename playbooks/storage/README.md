...
- Key vars: smb_shares, nfs_*, filesystem_mounts, usb_storage_quirks, mergerfs_*, zfs_*, virtiofs_*, vm_storage_gate_*.
...
| --- | --- | --- | --- |
| `filesystem-mounts.yml` | `linux_hosts` | Configure filesystem mounts and USB storage quirks. | `ansible-playbook playbooks/storage/filesystem-mounts.yml --syntax-check` |
