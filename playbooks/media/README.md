...
- Template owners: templates/media-maintenance, templates/streaming, templates/plex-appliance, templates/docker.
- Script owners: scripts/media-maintenance, scripts/media-release, scripts/streaming.
...
| `media-stack-health.yml` | `docker-vm` | Configure media stack health monitor. | `ansible-playbook playbooks/media/media-stack-health.yml --syntax-check` |
