...
| `nightly-media-maintenance.yml` | `nas_server, media-vm:docker-vm` | Configure nightly media maintenance, the bounded Profilarr window, and guarded season-scoped Sonarr upgrades for large series. | `ansible-playbook playbooks/media/nightly-media-maintenance.yml --syntax-check` |
