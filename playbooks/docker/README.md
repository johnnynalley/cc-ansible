...
- Key vars: docker_stacks, docker_daemon_config, docker_auto_update_*,
  openclaw_docker_report_*, openclaw_docker_update_broker_*, gluetun_*, qbit_*.
...
| `openclaw-docker-update-broker.yml` | `docker_hosts` | Install a strict, separately approved, digest-bound service update broker; disabled by default. | `ansible-playbook playbooks/docker/openclaw-docker-update-broker.yml --syntax-check` |
